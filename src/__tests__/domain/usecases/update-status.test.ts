...
describe('UpdateStatusUseCase', () => {
  ...
  it('should call statusRepository.updateStatus with the given token, board id, status id and input', async () => {
    ...
    expect(mockStatusRepository.updateStatus).toHaveBeenCalledWith('valid-token', 1, 1, input);
  });
